...
f2.Constraint = class {
    ...
    constructor(opts) {
        ...
        this.restLength = opts.restLength == undefined ? p1.distanceTo(p2) : opts.restLength
        ...
        this.kconstant = opts.kconstant == undefined ? 1 / normCombinedInvMass : opts.kconstant;
        this.cdamp = opts.cdamp == undefined ? 2 * Math.sqrt(this.kconstant / normCombinedInvMass) : opts.cdamp;
    }
    step(dt) {
        var r1Rot = this.r1.rotate(this.body1.angle);
        var r2Rot = this.r2.rotate(this.body2.angle);
